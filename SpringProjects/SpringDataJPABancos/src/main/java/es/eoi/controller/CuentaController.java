...
public class CuentaController {
	...
	@ResponseStatus(value = HttpStatus.NO_CONTENT)
	public Object putMoney(@RequestParam (value="dni") String dni, @RequestParam (value="nombanco") String nombanco, @RequestParam (value="money") int money) {
		Cliente cli = clienteserv.buscarCliente(dni).get();
		Banco banc = bancoserv.buscarBancobyName(nombanco);
		...
		if (cli==null||banc==null)
			...
			return  "tu saldo es de: " + cuenta.takeMoney(money);
		}
	}
	
	@PutMapping(value = "/take",params={"dni","nombanco","money"})
	@ResponseStatus(value = HttpStatus.NO_CONTENT)
	public Object takeMoney(@RequestParam (value="dni") String dni, @RequestParam (value="nombanco") String nombanco, @RequestParam (value="money") int money) {
		Cliente cli = clienteserv.buscarCliente(dni).get();
		Banco banc = bancoserv.buscarBancobyName(nombanco);
